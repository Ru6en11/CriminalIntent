...
import com.bignerdranch.android.criminalintent.view.DatePickerFragment
import java.io.File
import java.util.*
...
class CrimeDetailFragment : Fragment(), DatePickerFragment.Callbacks {
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            ...
            //Проверить наличие адресной книги на устройстве
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when {
            ...
            requestCode == REQUEST_CONTACT && data != null -> {
                ...
                //выполняемый здесь запрос похож на предложение "where"
